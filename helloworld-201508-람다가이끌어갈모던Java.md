...
람다 표현식은 기회이자 도전이다. 명령형 스타일의 코드를 서술적으로 바꾸고 축약된 사고를 이끌어 기발하고 편리한 API를 내놓을 수 있는 바탕이 되지만 개발자는 이전보다 더 많이 고민해야 할 것이다. 결국 람다 표현식은 2010년대 중반 ‘모던 Java 개발자’의 상징이 될 만하다. 그리고 ‘모던’은 특정한 시대의 양식이라기보다는 시대의 변화에 맞춰 가는 정신일 것이다. Java가 앞으로 다른 언어와 비교해도 현대적인 발전을 이어갈 수 있을지 지켜보는 일도 흥미롭다.
